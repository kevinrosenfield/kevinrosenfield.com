...
excerpt: <a id="img-div2" class="excerpt-link" href="https://kevinrosenfield.com/Pymate/"><img src="/images/monkeys.jpg" alt="Image" width="50%" height=auto><div id="img-box2" style="top:-60px;height:0px;width:100%;background-color:black;justify-self:center;opacity:0.5;position:relative"></div><div id="img-caption2" style="top:-113px;left:3px;height:0px;width:100%;justify-self:center;position:relative;opacity:1.0;color:white;text-align:left;">TEXT HERE </div></a></a>
---
<div>
<p>
