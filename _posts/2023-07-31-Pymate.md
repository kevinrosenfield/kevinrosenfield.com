...
excerpt: <a id="img-div2" class="excerpt-link" style="position:relative" href="https://kevinrosenfield.com/Pymate/"><img src="/images/monkeys.jpg" alt="Image" width="50%" height=auto><div id="img-box2" style="bottom:5px;height:55px;width:100%;background-color:black;justify-self:center;opacity:0.5;position:absolute;display:none;"></div><div id="img-caption2" style="bottom:5px;left:3px;height:55px;width:100%;justify-self:center;position:absolute;opacity:1.0;color:white;text-align:left;display:none;">Read More</div></a>
---
<div>
<p>
